...
class ReactorViewer {
    constructor() {
        this.config = {
            ...
            COLORS: {
                CORPUS: 0x005ebb,      // Темно-синий для корпуса
                LID: 0xbb5e00,         // Оранжевый для крышки
                TVS: 0x00bb00,         // Зеленый для ТВС
                HIGHLIGHT: 0xbb00bb    // Золотой для выделения
            },
            INITIAL_CAMERA: {
                x: 0,
                y: 3800,
    ...
    setupScene() {
        ...
        this.scene.background = new THREE.Color(0x414a4c);
    }
...
disassembleTVS() {
    ...
    getPartInfo(partType, index = null) {
        const baseInfo = {
            ...
            lid: {
                name: "Крышка реактора, регулирующие стрежни и приводы реактора РИМ-К-4,5",
                description: "Верхняя крышка реактора с механизмами для управления регулирующими стержнями",
                specs: [
                    { label: "Материал крышки", value: "ЭП-823 сталь" },
                    { label: "Толщина крышки", value: "188 мм" },
                    { label: "Диаметр крышки", value: "500 мм" },
                    { label: "Высота привода", value: "510 мм" },
                ]
            },
            tvs: {
